  ...
  while (socket->Recv ())
    {
      ...
      else if (rsu.cycle_num == OBU_NODE-1)
      {
          ...
          float m_cbr = cbr;
          std::ofstream out;
          out.open("/home/taekyung/ns-allinone-3.35/ns-3.35/V2X_csv/V2X_300_0.16.csv", std::ios::app);
...
int main (int argc, char *argv[])
{
  ...
  std::string animFile = "/home/taekyung/ns-allinone-3.35/ns-3.35/V2X_csv/wave-80211p(300_0.16).xml" ;  // Name of file for animation output
