  ...
  while (socket->Recv ())
    {
      ...
      else if (rsu.cycle_num == OBU_NODE-1)
      {
          ...
          float m_cbr = cbr;
          std::ofstream out;
          out.open("/home/taekyung/ns-allinone-3.35/ns-3.35/V2X_csv/V2X_500_0.16.csv", std::ios::app);
...
int main (int argc, char *argv[])
{
  ...
  std::string animFile = "/home/taekyung/ns-allinone-3.35/ns-3.35/V2X_csv/wave-80211p(500_0.16).xml" ;  // Name of file for animation output
  ...
  for(int j = 0 ; j<TOTAL_TIME; j++)
  {
    ...
    for(int i = 1; i <OBU_NODE + RSU_NODE ;i++)
    {
      ...
      if(j!=0)
        ...
        onoff.SetConstantRate (DataRate ("11Kb/s"),BSM_PACKET_SIZE);
    ...
    uint32_t rsu_icon = anim.AddResource("/home/taekyung/Pictures/RSU.png");
    uint32_t bluecar_icon = anim.AddResource("/home/taekyung/Pictures/OBU.png");
